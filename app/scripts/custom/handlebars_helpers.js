...
/**
 * 
 * will format the date to mm/dd/yyyy
 * 
 * usage
 * 
 * ```handlebar
...
Ember.Handlebars.registerHelper('format-date', function(date) {
    return moment(this.get(date)).format('L');
});

/**
 * 
 * will pluralaize a noun
 * 
 * usage
 * 
 * ```handlebar
 ...
 * 
 * 
 * @param {string} noun - non-pluralazied noun 
